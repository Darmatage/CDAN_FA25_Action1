...
public class GameInventory : MonoBehaviour {
      ...
      public TMP_Text item4Text;
      public TMP_Text item5Text;
...
//
      ...
      void InventoryDisplay(){
            ...
            item1Text.text = ("" + item1num);
            item2Text.text = ("" + item2num);
            item3Text.text = ("" + item3num);
            item4Text.text = ("" + item4num);
            item5Text.text = ("" + item5num);
      }
